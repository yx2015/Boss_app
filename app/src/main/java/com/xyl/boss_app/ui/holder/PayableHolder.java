...
public class PayableHolder extends ViewHolderBase<FeeDto.FeeDtoInfo.FeeInfo> {
    ...
    public void showData(int i, FeeDto.FeeDtoInfo.FeeInfo feeInfo) {
        ...
        mFee.setText("-" + mFormat.format(feeInfo.getPayableMoney()));
        ...
        mShiShouFee.setText("实付" + mFormat.format(feeInfo.getPrepaidMoney()));
    }
}
